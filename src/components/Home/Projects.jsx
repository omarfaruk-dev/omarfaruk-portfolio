      ...
      {selectedProject && (
        ...
        >
          ...
          >
            ...
            <p className="mb-4 text-secondary/80">
              <span className="font-semibold text-primary">Potential Improvements and Future Plans:</span>{" "}
              {selectedProject.PotentialImprovementsAndFuturePlans}
            </p>
            {/* Technologies */}
            ...
            {/* Buttons */}
            <div className="flex flex-wrap items-center justify-center gap-3 text-sm pt-5">
              <a
